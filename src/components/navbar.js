...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-blue-900 mb-2 shadow-md">
      {({ open }) => (
        <>
            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <Link href={"/"}>
                    <h2 className="block lg:hidden h-8 w-auto text-white text-2xl leading-6 cursor-pointer">Shopping</h2>
                  </Link>
                  <Link href={"/"}>
                    <h2 className="hidden lg:block h-8 w-auto text-white text-2xl leading-6 cursor-pointer">Shopping</h2>
                  </Link>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="ml-3 relative z-50">
                  <div>
                    <Menu.Button className="bg-blue-800 flex  text-3xl text-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-800 focus:ring-white">
